...
# 🚀 3D Model Website Integration

> **Hunyuan3D-2 + React**
> This project integrates Tencent's state-of-the-art Hunyuan3D-2 model with a modern React frontend, enabling real-time 3D model generation directly from your web browser.

## ⚡ Quick Start

This repository contains both the **Hunyuan3D-2 Backend** and a **React Frontend Demo**.

### 1. Start the Backend API
Ensure you have the environment set up as per the [Installation](#install-requirements) section below.
```bash
python api_server.py --host 0.0.0.0 --port 8081 --enable_tex
```

### 2. Start the React Frontend
Navigate to the demo folder and launch the interface:
```bash
cd react-3d-demo
npm install
npm run dev
